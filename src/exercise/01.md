...
- const doesn't mean you can't update the other elements of an object
- get the required elements first and then alter as needed
- bonus exercise: I did this by assigning an ID to the body tag, is there another way?
- oh, it can be document.body.append - body already has its own assumed presence in document
