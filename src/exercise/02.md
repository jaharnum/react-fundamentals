...
- my solution to the extra credit is a lot bulkier than the given solution, which creates the span children inside the element creation function for the main div element using React.createELement('span', null, 'Hello')
